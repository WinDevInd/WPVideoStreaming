...
{
    protected class BasePage : Page
    {
        public static readonly DependencyProperty SupportedOrientationsProperty =
        DependencyProperty.RegisterAttached("SupportedOrientations", typeof(String), typeof(BasePage), new PropertyMetadata(null, OnSupportedOrientationsChanged));
